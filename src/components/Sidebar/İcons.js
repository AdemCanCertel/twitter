export default function Svg({ children, className }) {
    return(
...
export const HomeIcon = () => {
    return(
        <Svg className="h7 w-7 text-white">
...
export const Circle = () => {
    return(
        <Svg className="text-primary-trends_d_color h-4 w-4">
...
export const Media = () => {
    return(
        <Svg className="h-6 w-6 text-primary-button">
...
export const Reply = () => {
    return(
        <Svg className="h-5 w-5 hover:text-primary-tweetbox_colors">
...
export const Retweet = () => {
    return(
        <Svg className="h-5 w-5 hover:text-primary-retweet">
...
export const Like = () => {
    return(
        <Svg className="h-5 w-5 hover:text-primary-like">
...
export const Share = () => {
    return(
        <Svg className="h-5 w-5 text-primary-gray_colors">
